import { formatClinicalDate, patientAge, patientGenderLabel } from '../../../utils/clinicalPresentation.js';
...
export default function LabPatientOverview({ patient, onChangePatient }) {
  return (
    ...
    >
      ...
      <div className="reception-his-form-row reception-his-form-row--4">
        <DisplayField label="Âge" value={patientAge(patient, '')} />
        <DisplayField label="Sexe" value={patientGenderLabel(patient.gender, '')} />
