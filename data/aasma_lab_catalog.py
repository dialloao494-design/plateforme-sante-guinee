...
_AASMA_TARIFF_LINES: list[tuple[str, str, int]] = [
    # Photo 1 (IMG_1178)
    ("IMMUNO-SEROLOGIE", "Ac anti HBc Total", 250_000),
    ("IMMUNO-SEROLOGIE", "Ac anti-HBe", 300_000),
    ("IMMUNO-SEROLOGIE", "Ac anti-HBs quantitatif", 250_000),
    ("IMMUNO-SEROLOGIE", "Ac anti-HCV", 250_000),
    ("BIOCHIMIE", "Acide folique", 350_000),
    ("BIOCHIMIE", "Acide urique", 60_000),
    ("MARQUEURS CANCEREUX", "AFP- Alpha foetoprotéine", 300_000),
    ("IMMUNO-SEROLOGIE", "AgHBe", 400_000),
    ("IMMUNO-SEROLOGIE", "AgHBs avec ELISA", 250_000),
    ...
    ("MARQUEURS CANCEREUX", "CA 125", 500_000),
    ("MARQUEURS CANCEREUX", "CA 15-3", 500_000),
    ("MARQUEURS CANCEREUX", "CA 19-9", 500_000),
    ...
    ("BACTERIOLOGIE", "Coproculture", 300_000),
    # Photo 2 (IMG_1180)
    ("BIOCHIMIE", "Créatinine (créatinémie)", 60_000),
    ("HEMOSTASE", "D-Dimères", 500_000),
    ("BACTERIOLOGIE", "ECB du pus + Antibiogramme", 250_000),
    ("BACTERIOLOGIE", "ECBSV+Antibiogramme", 300_000),
    ("BACTERIOLOGIE", "ECBU + Antibiogramme", 300_000),
    ...
    ("AUTRES EXAMENS", "Hépatite B (AgHBs) bandelette", 100_000),
    ...
    ("BIOCHIMIE", "Microalbuminurie", 100_000),
    ...
    ("BIOCHIMIE", "Phosphore (phosphorémie)", 90_000),
    ...
    ("HEMOSTASE", "Temps de coagulation", 50_000),
    ("HEMOSTASE", "Temps de saignement", 40_000),
