...
- [PASS] **Email** — Email provider: resend ({"status":"ok","configured":true,"provider":"resend","sender_set":true,"frontend_url_set":true})
- [PASS] **Infrastructure** — GET /auth/email-status -> 200 ({"configured":true,"provider":"resend","sender_set":true,"frontend_url_set":true})
...
- [PASS] **Isolation** — Clinic B cannot see clinic A patient (patient_id=28 visible_in_b=False)
- [PASS] **Smoke journey** — Using existing clinic (id=1)
- [PASS] **Smoke journey** — Staff receptionist login (audit.recv.9a4b5d83@sante-gn.test)
- [PASS] **Smoke journey** — Staff nutritionist login (audit.nutri.9a4b5d83@sante-gn.test)
- [PASS] **Smoke journey** — Staff midwife login (audit.midwife.9a4b5d83@sante-gn.test)
- [PASS] **Smoke journey** — Staff doctor login (audit.doc.9a4b5d83@sante-gn.test)
- [PASS] **Smoke journey** — Staff lab_technician login (audit.lab.9a4b5d83@sante-gn.test)
- [PASS] **Smoke journey** — Staff pharmacist login (audit.pharma.9a4b5d83@sante-gn.test)
...
- [PASS] **Smoke journey** — PEV record ({"id":6,"clinic_id":1,"patient_id":29,"vaccine_code":"BCG","vaccine_name":"BCG","dose_label":"Naissa)
- [PASS] **Smoke journey** — Laboratory queue (200)
- [PASS] **Smoke journey** — Pharmacy queue (200)
- [PASS] **Smoke journey** — Full child workflow completed ({"suffix": "9a4b5d83", "clinic_id": 1, "patient_id": 29, "workflow_id": 6, "after_reception": "nutrition", "after_nutrition": "pev", "after_pev": "doctor", "after_doctor": "doctor"})
