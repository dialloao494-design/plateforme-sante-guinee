...
Every staff account must be assigned to a clinic (clinic_id), except platform_admin.
"""
...
def requires_clinic_assignment(role: str) -> bool:
    """Staff and clinic-affiliated doctors must have clinic_id (not platform_admin)."""
