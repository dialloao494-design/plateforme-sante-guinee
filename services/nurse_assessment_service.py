...
def _combine_history(assessment: models.NurseAssessment) -> Optional[str]:
    ...
    mapping = [
        ...
        ("Plan de soins", assessment.care_plan),
        ("Transmission SBAR", assessment.handover_sbar),
        ("Administration médicamenteuse", assessment.medication_administration),
        ("Prélèvements", assessment.specimen_collection),
        ("Plaies", assessment.wound_assessment),
        ("Sécurité patient", assessment.safety_checklist),
    ]
...
def _serialize_assessment(row: models.NurseAssessment) -> na_schemas.NurseAssessmentResponse:
    ...
    return na_schemas.NurseAssessmentResponse(
        ...
        arm_circumference_cm=row.arm_circumference_cm,
        ...
        handover_sbar=row.handover_sbar,
        medication_administration=row.medication_administration,
        specimen_collection=row.specimen_collection,
        wound_assessment=row.wound_assessment,
        safety_checklist=row.safety_checklist,
